...
class App extends Component {
  ...
  redirect = () => {
    switch (this.state.gameType) {
      case "multiplayer":
        return <Redirect push to="/~17_syslo/rummikub/game-management" />;
      case "singleplayer":
        return <Redirect push to="/~17_syslo/rummikub/add-players" />;
      case "localgame":
        return <Redirect push to="/~17_syslo/rummikub/add-players" />;
      default:
        return null;
      ...
      <div>
        <Router>
          ...
          <Switch>
            ...
            ></Route>
            <Route
              path="/~17_syslo/rummikub/game-management"
              render={() => (
                <GameManagement
            ...
            ></Route>
            <Route
              path="/~17_syslo/rummikub/waiting-for-players"
              render={() => (
                <WaitingView
            ...
            ></Route>
            <Route
              path="/~17_syslo/rummikub/new-game"
              render={() => (
                <NewGame
                  gameName={this.state.gameName}
            ...
            ></Route>
            <Route
              path="/~17_syslo/rummikub/add-players"
              render={() => (
                <AddPlayers
                  gameType={this.state.gameType}
                  founderName={this.state.playerName}
